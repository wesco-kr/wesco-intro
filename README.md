...
## 구성
- 14쪽 고정 판형(1120×720) — 표지 · 회사 소개 · 연혁 · 용도 · 사고 손실 · 사양서 요구 · 라인업 · 장점 · TSP vs UPS · 개별·중앙 보상 · Sag-VIEWER · 글로벌 레퍼런스 · 글로벌 네트워크 · 뒷표지 (2026-09-15 축약판 → 09-17 3쪽 추가. 연혁은 대표이사 TI Malaysia 브리프(2026-06) 기준)
...
| 경로 | 역할 |
|---|---|
| `index.html` | 본체 — 스타일·14쪽·스크립트 단일 파일 |
...
| `images/proof/install_semi_2026.jpg` | 회사소개(p2) 현장 사진 — 원본 `07-영업자료/02.사진/00.설치사진/3상/WD-2026-CIP-50K.jpg`(2026 설치, 150kVA). 구 `install_semi.jpg`(2010년대)는 `all-new-intro.html`만 참조 |
...
## 데이터 출처
WESCO-사업소개서-2025-Ver3.5 · 검증 수치만 사용(50,000+ Units · 900+ Companies · 15+ Countries · 2001년 설립)
